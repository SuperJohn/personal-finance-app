...
# Load data ---------------------------------------------------------------
# tiller_categories_data <- read_sheet("1ek3bZQm6YewCk1kU3GkF4oPniKSkBDRORpzaM8ZysjM", sheet = "Categories")
tiller_categories_data <- read_csv("data/categories.csv", col_types = category_col_types)
# tiller_transactions <- read_sheet("1ek3bZQm6YewCk1kU3GkF4oPniKSkBDRORpzaM8ZysjM", sheet = "Transactions")
tiller_transactions <- read_csv("data/transactions.csv", col_types = transactions_col_types)
# balance_history <- read_sheet("1ek3bZQm6YewCk1kU3GkF4oPniKSkBDRORpzaM8ZysjM", sheet = "Balance History")
